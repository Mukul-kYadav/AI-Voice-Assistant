...
__all__ = [
    'SPEI_UNDEFINED', 'ISpeechLexiconPronunciation', 'SPPS_Verb',
    'tagSPTEXTSELECTIONINFO', 'SPWORDPRONOUNCEABLE', 'SpLexicon',
    'DISPID_SDKEnumKeys', 'Speech_StreamPos_Asap',
    'SpeechCategoryAudioOut', 'DISPID_SWFEAvgBytesPerSec',
    'SPVPRIORITY', 'DISPID_SRGRecoContext', 'DISPID_SPILanguageId',
    'STSF_FlagCreate', 'DISPID_SVEAudioLevel', 'SWTAdded',
    'DISPID_SOTCreateInstance', 'SPEI_ADAPTATION', 'ISpAudio',
    'SAFTADPCM_22kHzStereo', 'SGLexical', 'DISPID_SRCBookmark',
    'SPEI_RESERVED2', 'tagSTATSTG', 'SPCT_SUB_COMMAND', 'SPPHRASE',
    'SBOPause', 'DISPID_SRRecognizer', 'SP_VISEME_9',
    'SAFTNonStandardFormat', 'SAFTGSM610_8kHzMono',
    'ISpGrammarBuilder', 'SPEI_RESERVED6', 'DISPID_SpeechGrammarRule',
    'SPGS_ENABLED', 'DISPID_SVSInputWordLength', 'ISpLexicon',
    'DISPID_SABufferInfo', 'DISPID_SLAddPronunciationByPhoneIds',
    'ISpRecoGrammar', 'SVEAllEvents', 'DISPID_SpeechVoiceEvent',
    'ISpeechXMLRecoResult', 'DISPID_SLAddPronunciation',
    'DISPID_SLPsCount', 'SpeechBookmarkOptions', 'SVP_12',
    'SGRSTTWord', 'SPAUDIOSTATE', 'DISPID_SRCERecognizerStateChange',
    'SGRSTTWildcard', 'SpeechDiscardType', 'DISPID_SRCEEndStream',
    'SAFT8kHz16BitMono', 'SVPOver', 'SVEEndInputStream', 'SITooLoud',
    'SAFTGSM610_44kHzMono', 'DISPID_SGRSTsItem', 'SBONone',
    'DISPID_SGRSTWeight', 'DISPID_SGRsItem', 'SPPS_SuppressWord',
    'DISPID_SPPConfidence', 'SFTSREngine', 'DISPID_SPIAudioSizeBytes',
    'SPAUDIOOPTIONS', 'SFTInput', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SLGenerationId', 'DISPID_SABIEventBias',
    'DISPID_SRGetFormat', 'ISpXMLRecoResult',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVSInputWordPosition',
    'SPSInterjection', 'SP_VISEME_2', 'SpeechPropertyResponseSpeed',
    'SDTPronunciation', 'SpeechPropertyAdaptationOn', 'SDTProperty',
    'DISPID_SLPPartOfSpeech', 'SREStateChange', 'SPWF_INPUT',
    'DISPID_SPARecoResult', 'ISpResourceManager', 'DISPID_SLGetWords',
    'eLEXTYPE_PRIVATE2', 'DISPID_SPACommit', 'SPTEXTSELECTIONINFO',
    'SPRECOCONTEXTSTATUS', 'DISPID_SpeechRecoContext',
    'SAFTCCITT_ALaw_11kHzMono', 'SINoSignal',
    'DISPID_SpeechPhoneConverter', 'DISPID_SRCPause', 'SPGS_DISABLED',
    'SpFileStream', 'DISPID_SPAsCount', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SMSADeviceId', 'ISpVoice', 'DISPID_SRRSpeakAudio',
    'SVP_6', 'SPPHRASERULE', 'SpInprocRecognizer', 'DISPID_SLPsItem',
    'SPSTREAMFORMATTYPE', 'SVP_8', 'DISPID_SABufferNotifySize',
    'DISPID_SRSetPropertyString', 'eLEXTYPE_PRIVATE11', 'SASPause',
    'SP_VISEME_12', 'SAFTGSM610_11kHzMono',
    'SWPKnownWordPronounceable', 'DISPID_SOTGetStorageFileName',
    'DISPID_SpeechPhraseRule', 'DISPID_SVSLastStreamNumberQueued',
    'SPDKL_CurrentUser', 'DISPID_SRState',
    'ISpeechGrammarRuleStateTransition', 'SAFT22kHz16BitStereo',
    'DISPID_SPERequiredConfidence', 'SITooFast',
    'SPEI_END_INPUT_STREAM', 'SVESentenceBoundary', 'DISPID_SPRText',
    'SAFTCCITT_ALaw_22kHzMono', 'SPDATAKEYLOCATION',
    'DISPID_SpeechRecoResultTimes', 'Speech_Max_Pron_Length',
    'SVSFParseSapi', 'SSTTWildcard', 'DISPIDSPTSI_ActiveLength',
    'SPRST_INACTIVE', 'ISpRecoCategory', 'DISPID_SDKOpenKey',
    'DISPID_SPPId', 'ISpeechRecognizerStatus', 'SECFIgnoreKanaType',
    'SAFTText', 'DISPID_SRGDictationLoad', 'DISPID_SVSkip', 'SRARoot',
    'ISpPhrase', 'DISPID_SVSVisemeId', 'DISPID_SGRAddState', 'SINone',
    'DISPID_SPCIdToPhone', 'DISPID_SGRInitialState',
    'SPFM_OPEN_READONLY', '_RemotableHandle', 'DISPID_SDKEnumValues',
    'SAFTCCITT_ALaw_11kHzStereo', 'SASRun',
    'SpeechEmulationCompareFlags', 'DISPID_SOTIsUISupported',
    'DISPID_SASNonBlockingIO', 'ISpeechRecoResultDispatch',
    'SpeechLoadOption', 'eWORDTYPE_ADDED', 'ISpeechPhraseReplacement',
    'SECHighConfidence', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechPhraseProperty', 'SGDSActive', 'SPCT_SLEEP',
    'SpeechDisplayAttributes', 'eLEXTYPE_PRIVATE3', 'SVP_0',
    'DISPID_SVPause', 'STSF_CommonAppData', 'SITooQuiet',
    'DISPID_SGRSTransitions', 'IEnumString', 'eLEXTYPE_PRIVATE16',
    'DISPID_SRCResume', 'DISPID_SVSInputSentenceLength', 'SVP_3',
    'DISPID_SOTs_NewEnum', 'DISPID_SpeechObjectTokenCategory',
    'SPWORDTYPE', 'SVF_Emphasis', 'SPEVENT', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPCPhoneToId', 'DISPID_SVSLastResult',
    'SPINTERFERENCE_NOISE', 'STCInprocHandler',
    'SpTextSelectionInformation', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SDKGetStringValue', 'SVEWordBoundary',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPRST_INACTIVE_WITH_PURGE',
    'SPEI_SOUND_END', 'SVP_2', 'ISpeechRecoGrammar',
    'DISPID_SPRulesItem', 'DISPID_SPPName',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SMSAMMHandle',
    'SpeechStreamFileMode', 'DISPID_SRSClsidEngine', 'SP_VISEME_18',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRGSetTextSelection',
    'SGSDisabled', 'DISPID_SWFEChannels', 'DISPID_SPAsItem',
    'eLEXTYPE_RESERVED8', 'DISPID_SRRTimes', 'SPEI_START_SR_STREAM',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SAFGuid', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SASFreeBufferSpace', 'ISpNotifySink',
    'SGDSActiveUserDelimited', 'DISPID_SWFEBitsPerSample',
    'DISPID_SVVoice', 'DISPID_SVSRunningState',
    'DISPID_SpeechLexiconPronunciation', 'SVP_7', 'SPPS_Interjection',
    'DISPID_SDKCreateKey', 'SPFM_NUM_MODES',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRGCmdLoadFromMemory',
    'SPSVerb', 'DISPID_SBSRead', 'SRATopLevel', 'DISPID_SPIStartTime',
    'SPDKL_DefaultLocation', 'DISPID_SMSALineId', 'SPEI_RESERVED3',
    'SAFT11kHz16BitMono', 'SDTAudio', 'DISPID_SAStatus',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SVGetVoices',
    'DISPID_SVGetProfiles', 'SP_VISEME_5', 'SPAUDIOBUFFERINFO',
    'DISPID_SOTMatchesAttributes', 'SREBookmark', 'DISPID_SOTCId',
    'DISPID_SRGetPropertyString', 'DISPID_SLWType',
    'SAFT12kHz16BitMono', 'SVP_13', 'DISPID_SRCState',
    'SPGRAMMARSTATE', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRSetPropertyNumber', 'DISPID_SDKSetLongValue',
    'SDKLLocalMachine', 'SAFT32kHz16BitMono',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechMMSysAudio',
    'SPEI_START_INPUT_STREAM', 'DISPID_SDKGetBinaryValue',
    'SPCT_SUB_DICTATION', 'DISPID_SRCVoicePurgeEvent',
    'ISpeechTextSelectionInformation', 'ISpeechAudio',
    'DISPID_SVVolume', 'DISPID_SpeechLexiconProns',
    'SECFEmulateResult', 'SP_VISEME_10', 'SpeechAudioState',
    'SPVISEMES', 'eLEXTYPE_VENDORLEXICON', 'SPAR_Medium',
    'DISPID_SAVolume', 'DISPID_SLWsItem', 'SPWAVEFORMATTYPE',
    'SVEVoiceChange', 'SRSInactiveWithPurge',
    'DISPID_SRCEEnginePrivate', 'DISPID_SpeechPhraseElement',
    'ISpEventSink', 'SpeechAudioFormatType', 'DISPID_SGRId',
    'eLEXTYPE_PRIVATE5', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SRRRecoContext', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPPS_Noncontent', 'SRTEmulated', 'ISpeechPhraseRule',
    'SPPS_Unknown', 'DISPID_SVSpeak',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SOTDataKey', 'SpMMAudioOut', 'eLEXTYPE_PRIVATE10',
    'DISPID_SDKDeleteValue', 'DISPID_SOTRemove', 'ISpeechVoice',
    'SPAS_RUN', 'DISPID_SVWaitUntilDone', 'SPINTERFERENCE_TOOFAST',
    'SpSharedRecoContext', 'SAFT48kHz16BitStereo',
    'SpeechVoicePriority', 'SAFT24kHz16BitStereo',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPIDSPTSI_SelectionOffset',
    'ISpeechPhraseElement', 'DISPID_SpeechLexiconWord',
    'SDTReplacement', 'SDTDisplayText', 'DISPID_SOTSetId',
    'SGRSTTEpsilon', 'ISpNotifyTranslator', 'SPSNoun',
    'ISpeechRecoResultTimes', 'DISPID_SRRTTickCount',
    'DISPID_SBSSeek', 'SDA_One_Trailing_Space', 'SVP_10',
    'SREInterference', 'SVSFNLPSpeakPunc', 'SPINTERFERENCE_NOSIGNAL',
    'ISpObjectTokenCategory', 'DISPID_SRCRequestedUIType',
    'SPEVENTENUM', 'DISPID_SRCERecognition', 'SAFT48kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SOTCategory',
    'ISpeechLexiconWord', 'DISPID_SMSSetData', 'SAFT22kHz16BitMono',
    'SECNormalConfidence', 'ISpObjectWithToken',
    'eLEXTYPE_USER_SHORTCUT', 'SpMemoryStream',
    'ISpeechResourceLoader', 'ISpRecognizer', 'SP_VISEME_7',
    'SPBO_AHEAD', 'ISpeechLexiconPronunciations',
    'DISPID_SOTGetAttribute', 'SpStream', 'DISPID_SPRuleId',
    'DISPID_SRCEAdaptation', 'DISPID_SRRAudio', 'DISPID_SPEs_NewEnum',
    'SRSInactive', 'SRSEIsSpeaking', 'ISpeechPhraseInfoBuilder',
    'SSFMOpenForRead', 'SREPrivate', 'SPRS_ACTIVE',
    'SpeechVoiceEvents', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SREStreamStart', 'SpeechWordPronounceable',
    'SAFT12kHz8BitStereo', 'DISPID_SPEDisplayText', 'SASClosed',
    'DISPID_SVPriority', 'SPFM_CREATE_ALWAYS',
    'SpeechCategoryRecognizers', 'eLEXTYPE_PRIVATE9',
    'SpeechTokenShellFolder', 'DISPID_SCSBaseStream',
    'DISPID_SASState', 'SPEI_TTS_BOOKMARK', 'SREStreamEnd',
    'DISPID_SpeechVoiceStatus', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT48kHz8BitMono', 'DISPID_SVSPhonemeId', 'SPWF_SRENGINE',
    'SPPS_NotOverriden', 'SpeechRuleState', 'DISPID_SFSOpen',
    'eLEXTYPE_PRIVATE13', 'DISPID_SOTId', 'eLEXTYPE_RESERVED10',
    'SpeechRecoContextState', 'DISPID_SRSCurrentStreamNumber',
    'ISpeechCustomStream', 'DISPID_SRGetRecognizers',
    'SpeechPropertyLowConfidenceThreshold', 'SPEI_HYPOTHESIS',
    'SpNotifyTranslator', 'DISPID_SLPs_NewEnum', 'SVSFUnusedFlags',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SPRuleParent',
    'DISPID_SRRAlternates', 'SpeechTokenIdUserLexicon',
    'SpResourceManager', 'SAFT44kHz16BitMono', 'SPVPRI_OVER',
    'DISPID_SpeechLexicon', 'DISPID_SPIProperties',
    'SAFTADPCM_8kHzStereo', 'DISPIDSPTSI_ActiveOffset',
    'SAFT24kHz8BitStereo', 'DISPID_SLPPhoneIds',
    'SAFT16kHz8BitStereo', 'SRTStandard', 'SPXRO_Alternates_SML',
    'SPCONTEXTSTATE', 'SVP_4', 'DISPID_SBSFormat',
    'SDKLDefaultLocation', 'SpPhoneConverter',
    'SpPhoneticAlphabetConverter', 'DISPID_SPRuleEngineConfidence',
    'SPEI_SR_RETAINEDAUDIO', 'IEnumSpObjectTokens',
    'DISPID_SPPEngineConfidence', 'SPWT_DISPLAY',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE12', 'SPBINARYGRAMMAR', 'DISPID_SGRClear',
    'tagSPPROPERTYINFO', 'SPSMF_SAPI_PROPERTIES',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRRPhraseInfo', 'DISPID_SRCEStartStream',
    'DISPID_SLWPronunciations', 'ISpeechRecoResult', 'SVSFParseSsml',
    'eLEXTYPE_PRIVATE6', 'SPAO_RETAIN_AUDIO',
    'DISPID_SLGetPronunciations', 'ISpeechGrammarRules',
    'SPSNotOverriden', 'DISPID_SABIBufferSize',
    'DISPIDSPTSI_SelectionLength', 'SPRECOGNIZERSTATUS',
    'DISPID_SVAudioOutputStream', 'SECFIgnoreCase',
    'DISPID_SRGCommit', 'SVP_18', 'DISPID_SPAStartElementInResult',
    'SVP_19', 'DISPID_SVEBookmark', 'ISpeechRecoContext',
    'SGRSTTDictation', 'DISPID_SOTGetDescription', 'SP_VISEME_17',
    'DISPID_SVSInputSentencePosition', 'SRERecoOtherContext',
    'SRERequestUI', 'SAFTCCITT_uLaw_8kHzMono', 'SPPS_LMA',
    'DISPID_SPIReplacements', 'SPEI_MIN_TTS', 'STCLocalServer',
    'DISPID_SPIEngineId', 'ISpeechRecoResult2', 'SSFMCreateForWrite',
    'SPVPRI_NORMAL', 'SpeechRetainedAudioOptions',
    'SpUnCompressedLexicon', 'SPBO_PAUSE', 'DISPID_SFSClose',
    'SAFT8kHz8BitStereo', 'SpeechCategoryVoices', 'eLEXTYPE_USER',
    'DISPID_SGRSTNextState',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpStreamFormatConverter', 'DISPID_SPRuleFirstElement',
    'WAVEFORMATEX', 'SPSSuppressWord', 'DISPID_SRRDiscardResultInfo',
    'SpeechRecoProfileProperties', '_SPAUDIOSTATE', 'SPPS_RESERVED2',
    'DISPID_SVEventInterests',
    'DISPID_SRCERecognitionForOtherContext', 'SVEStartInputStream',
    'SECFDefault', 'SAFT11kHz8BitMono', 'SSFMCreate',
    'ISpPhoneConverter', 'SpNullPhoneConverter',
    'DISPID_SRCERequestUI', 'SpeechLexiconType', 'STSF_LocalAppData',
    'SGRSTTTextBuffer', 'DISPID_SOTCGetDataKey', 'DISPID_SRGRules',
    'SRSActiveAlways', 'SPEI_RECO_STATE_CHANGE',
    'SAFT11kHz16BitStereo', 'Speech_Max_Word_Length',
    'SPEI_SOUND_START', 'DISPID_SpeechPhraseBuilder',
    'eLEXTYPE_LETTERTOSOUND', '_ISpeechRecoContextEvents',
    'DISPID_SPEPronunciation', 'DISPID_SRCEventInterests',
    'eLEXTYPE_PRIVATE8', 'DISPID_SVSLastBookmarkId',
    ...
    'SPDKL_CurrentConfig', 'SPBO_TIME_UNITS', 'DISPID_SGRsFindRule',
    'DISPID_SRGDictationUnload', 'DISPID_SGRSTsCount',
    'ISpStreamFormatConverter', 'SREPropertyStringChange',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SPRsCount',
    'SVEAudioLevel', 'SPPS_Noun', 'UINT_PTR',
    'DISPID_SLRemovePronunciation', 'SGSEnabled', 'SPAS_STOP',
    'DISPID_SRGCmdLoadFromObject', 'SPCT_DICTATION',
    'eLEXTYPE_PRIVATE17', 'SP_VISEME_3', 'DISPID_SVEWord',
    'DISPID_SRProfile', 'SpeechAudioFormatGUIDText',
    'SPEI_PROPERTY_STRING_CHANGE', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SVESentenceBoundary', 'SPEI_MAX_SR',
    'SpObjectTokenCategory', 'SAFT8kHz8BitMono', 'eLEXTYPE_RESERVED9',
    'SWTDeleted', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SRRTOffsetFromStart', 'SRTReSent', 'SPAUDIOSTATUS',
    'DISPID_SpeechFileStream', 'DISPID_SGRAttributes',
    'ISpeechPhraseRules', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpeechTokenKeyAttributes', 'ISpeechObjectToken',
    'DISPID_SpeechRecognizer', 'ISpeechGrammarRuleStateTransitions',
    'SpeechVisemeType', 'SVF_None', 'SGDisplay', 'SVEViseme',
    'SPBO_NONE', 'SpeechRecognizerState', 'DISPID_SLPType',
    'SpWaveFormatEx', 'STSF_AppData', 'SAFT12kHz16BitStereo',
    'SVSFIsFilename', 'eLEXTYPE_APP', 'SAFT32kHz16BitStereo',
    'ISpEventSource', 'SpPhraseInfoBuilder',
    'SPINTERFERENCE_TOOQUIET', 'ISpeechMemoryStream', 'SPSFunction',
    'SVSFVoiceMask', 'SpeechRegistryUserRoot', 'ISpeechRecognizer',
    'SpeechGrammarTagDictation', 'SVSFPersistXML',
    'DISPID_SRSAudioStatus', 'SPSMF_UPS', 'SGRSTTRule', 'DISPIDSPRG',
    'SPFM_OPEN_READWRITE', 'ISpeechAudioStatus',
    'DISPID_SPIEnginePrivateData', 'SP_VISEME_20', 'SPPARTOFSPEECH',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SpeechAudioFormat',
    'ISpeechVoiceStatus', 'SRERecognition',
    'DISPID_SRCCmdMaxAlternates', 'SpeechMicTraining',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SOTCEnumerateTokens',
    'SpeechPropertyNormalConfidenceThreshold',
    'SAFTCCITT_uLaw_44kHzStereo', 'eLEXTYPE_PRIVATE1',
    'SAFTADPCM_22kHzMono', 'DISPID_SPISaveToMemory', 'SREAllEvents',
    'SPSHT_Unknown', 'DISPID_SRCEPhraseStart',
    'DISPID_SpeechGrammarRules', 'DISPID_SWFEBlockAlign',
    'SDKLCurrentConfig', 'SAFT11kHz8BitStereo',
    'SGDSActiveWithAutoPause', 'SAFT44kHz8BitMono',
    'SpeechTokenKeyFiles', 'DISPID_SRGCmdLoadFromFile',
    'SPEI_REQUEST_UI', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRGSetWordSequenceData', 'SAFT24kHz16BitMono',
    'DISPID_SPRules_NewEnum', 'DISPID_SVRate',
    'DISPID_SVGetAudioOutputs', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SGRSTPropertyName',
    'SPRS_INACTIVE', 'SPEI_VISEME', 'DISPID_SRGetPropertyNumber',
    'DISPID_SVEPhoneme', 'SPEI_PHONEME', 'IStream',
    'SAFTADPCM_11kHzMono', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPRuleChildren', '__MIDL_IWinTypes_0009',
    'SPSERIALIZEDRESULT', 'SpeechSpecialTransitionType',
    'ISpeechObjectTokenCategory', 'DISPID_SVAlertBoundary',
    'Speech_Default_Weight', 'DISPID_SRGReset',
    'DISPID_SRCEAudioLevel', 'STCAll', 'DISPID_SDKSetBinaryValue',
    'DISPID_SOTCSetId', 'SRAExport', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPEI_SR_BOOKMARK', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SVSLastBookmark', 'SpeechTokenValueCLSID',
    'eLEXTYPE_RESERVED6', 'SpVoice', 'ISpeechAudioBufferInfo',
    'DISPID_SpeechPhraseElements', 'SRSActive', 'DISPID_SBSWrite',
    'SRAORetainAudio', 'DISPID_SpeechObjectTokens', 'SSTTTextBuffer',
    'SDA_Consume_Leading_Spaces',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpeechPhraseProperty',
    'SpeechCategoryPhoneConverters', 'DISPID_SPPNumberOfElements',
    'SAFT32kHz8BitMono', '_ISpeechVoiceEvents', 'SVEBookmark',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SLPSymbolic', 'SP_VISEME_15',
    'DISPID_SpeechPhraseReplacements', 'SPSModifier',
    'SPINTERFERENCE', 'DISPID_SpeechMemoryStream',
    'SpeechPartOfSpeech', 'DISPID_SGRSTText', 'SVF_Stressed',
    'DISPID_SPAs_NewEnum', 'SpeechAudioFormatGUIDWave',
    'DISPID_SPRulesCount', 'DISPID_SVSCurrentStreamNumber',
    'SAFTCCITT_uLaw_11kHzStereo', 'SRESoundStart',
    'DISPID_SPIGrammarId', 'DISPID_SpeechBaseStream',
    'SAFT16kHz16BitStereo', 'DISPID_SPCLangId',
    'DISPID_SRIsUISupported', 'SpeechUserTraining',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SPELexicalForm',
    'SpeechVoiceSpeakFlags', 'DISPID_SPPsCount',
    'DISPID_SVSpeakStream', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SpeechVoice', 'DISPID_SGRSAddRuleTransition',
    'SPSHT_EMAIL', 'SpeechGrammarState', 'DISPID_SRStatus',
    'SpeechVoiceSkipTypeSentence', 'SWPUnknownWordUnpronounceable',
    'DISPID_SPEEngineConfidence', 'DISPID_SOTCDefault',
    'DISPID_SVGetAudioInputs', 'SVP_1', 'SPINTERFERENCE_NONE',
    'DISPID_SGRSTPropertyId', 'SRCS_Enabled', 'SPEI_TTS_PRIVATE',
    'SPEVENTSOURCEINFO', 'ISpeechPhraseAlternate', 'SDKLCurrentUser',
    'DISPID_SPPs_NewEnum', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPLEXICONTYPE', 'DISPID_SLWs_NewEnum', 'SAFT8kHz16BitStereo',
    'ISpRecognizer3', 'DISPID_SRCESoundStart', 'ISpNotifySource',
    'SPWT_LEXICAL', 'DISPID_SVAudioOutput',
    'DISPID_SpeechPhraseRules', 'DISPID_SLPLangId',
    'ISpeechGrammarRule', 'DISPID_SRGState',
    'DISPID_SPIRetainedSizeBytes', 'SPAR_High', 'DISPID_SGRName',
    'SPWORDLIST', 'SP_VISEME_19', 'SAFT44kHz8BitStereo',
    'SAFTADPCM_8kHzMono', 'DISPID_SABIMinNotification',
    'SREAdaptation', 'DISPID_SRCSetAdaptationData', 'SP_VISEME_16',
    'SpeechAudioVolume', 'SPGS_EXCLUSIVE', 'DISPID_SLWWord',
    'DISPID_SRRTLength', 'DISPID_SWFEExtraData',
    'SPINTERFERENCE_TOOLOUD', 'SAFT44kHz16BitStereo',
    'DISPID_SRRTStreamTime', 'SpeechRuleAttributes',
    'SpeechGrammarTagWildcard', 'DISPID_SPIElements', 'SVEPhoneme',
    'DISPID_SpeechWaveFormatEx', 'SINoise', 'SVSFIsXML',
    'DISPID_SPRsItem', 'SRTAutopause', 'ISpStream',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPPFirstElement',
    'SpCustomStream', 'ISpeechGrammarRuleState', 'SRTExtendableParse',
    'SLTUser', 'ISpeechDataKey', 'DISPID_SGRSAddWordTransition',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRRAudioFormat',
    'SPVPRI_ALERT', 'DISPID_SOTsItem', 'SPLO_DYNAMIC', 'SRAImport',
    'ISpPhoneticAlphabetSelection', 'SVSFlagsAsync',
    'SpeechGrammarWordType', 'DISPID_SVDisplayUI',
    'DISPID_SRCRetainedAudioFormat', 'SAFT22kHz8BitMono',
    'SDA_Two_Trailing_Spaces', 'SVP_17', 'SAFTDefault',
    'ISpStreamFormat', 'DISPID_SVEVoiceChange', 'ISpeechMMSysAudio',
    'SpAudioFormat', 'DISPID_SPRNumberOfElements',
    'DISPID_SGRsDynamic', 'SpeechTokenContext', 'ISpeechObjectTokens',
    'SPSHORTCUTTYPE', 'SPCS_ENABLED', 'SpeechPropertyResourceUsage',
    'SPWORDPRONUNCIATION', 'DISPID_SPEAudioTimeOffset',
    'SGSExclusive', 'ISpPhoneticAlphabetConverter',
    'ISpeechPhraseAlternates', 'SpeechCategoryRecoProfiles',
    'SpeechAudioProperties', 'SPRST_ACTIVE', 'DISPID_SAEventHandle',
    'SPWT_PRONUNCIATION', 'SAFT48kHz16BitMono',
    'SpeechCategoryAudioIn', 'DISPID_SPPValue',
    'SAFTCCITT_ALaw_44kHzMono', 'SASStop', 'DISPID_SPRs_NewEnum',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVEPrivate', 'SAFT16kHz16BitMono',
    'SLODynamic', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SSFMOpenReadWrite', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SVStatus', 'SECFNoSpecialChars', 'SP_VISEME_6',
    'DISPID_SRGId', 'DISPID_SpeechRecoContextEvents', 'ISpPhraseAlt',
    'SPLO_STATIC', 'STCRemoteServer', 'SP_VISEME_13', 'SPAR_Unknown',
    'ISpShortcut', 'ISpObjectToken', 'SLOStatic',
    'DISPID_SRCEPropertyNumberChange', 'SPPS_Function',
    'SAFT32kHz8BitStereo', 'ISpeechWaveFormatEx', 'SSTTDictation',
    'SPXMLRESULTOPTIONS', 'ISpSerializeState', 'SVSFPurgeBeforeSpeak',
    'SDTLexicalForm', 'SSSPTRelativeToCurrentPosition',
    'SPEI_SR_PRIVATE', 'SVPNormal', 'SP_VISEME_8', 'DISPID_SPEsCount',
    'SPGRAMMARWORDTYPE', 'ISpMMSysAudio', 'Speech_StreamPos_RealTime',
    'DISPIDSPTSI', 'DISPID_SPRDisplayAttributes', 'SPAO_NONE',
    'ISpeechPhraseElements', 'eLEXTYPE_PRIVATE4', 'DISPID_SRIsShared',
    'DISPID_SPAPhraseInfo', 'SVP_15', 'SAFTCCITT_uLaw_22kHzMono',
    'SAFTADPCM_44kHzStereo', 'SDTAlternates', 'ISpRecoResult',
    'DISPID_SMSGetData', 'SPCATEGORYTYPE', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SPRuleConfidence', 'SpeechAllElements',
    'SPBOOKMARKOPTIONS', 'STCInprocServer',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRCRetainedAudio',
    'DISPID_SAFType', 'SPFILEMODE', 'SDTRule', 'DISPID_SVResume',
    'SAFT24kHz8BitMono', 'SpeechCategoryAppLexicons',
    'eLEXTYPE_PRIVATE15', 'SRADynamic',
    'DISPID_SRSSupportedLanguages', 'SRSEDone', 'SPRULESTATE',
    'SpInProcRecoContext', 'SPEI_END_SR_STREAM', 'DISPID_SPRuleName',
    'SAFTADPCM_44kHzMono', 'eLEXTYPE_PRIVATE14',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SpeechCustomStream',
    'eLEXTYPE_PRIVATE19', 'ISpeechPhraseReplacements',
    'SpeechRunState', 'DISPID_SRRGetXMLResult', 'SpeechInterference',
    'ISpDataKey', 'DISPID_SPPParent', 'SPSHT_OTHER', 'SVSFIsNotXML',
    'DISPID_SASetState', 'SPFM_CREATE', 'SpeechEngineProperties',
    'SPPS_RESERVED4', 'ISpRecoGrammar2', 'ISpeechAudioFormat',
    'SECFIgnoreWidth', 'DISPID_SRCEBookmark',
    'DISPID_SVIsUISupported', 'SWPUnknownWordPronounceable',
    'DISPID_SLWLangId', 'SPDKL_LocalMachine', 'SPPHRASEREPLACEMENT',
    'eLEXTYPE_PRIVATE20', 'SAFTGSM610_22kHzMono', 'SPAS_CLOSED',
    'SAFT16kHz8BitMono', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SLGetGenerationChange', 'SPAS_PAUSE',
    'ISpeechPhraseProperties', 'DISPID_SPEActualConfidence',
    'SP_VISEME_11', 'SpeechDataKeyLocation', 'SPRST_NUM_STATES',
    ...
    'DISPID_SPPChildren', 'SPSHT_NotOverriden', 'SPPS_RESERVED1',
    'DISPID_SRGIsPronounceable', 'eLEXTYPE_PRIVATE7',
    'SAFTExtendedAudioFormat', 'DISPID_SDKGetlongValue',
    'SpeechTokenKeyUI', 'DISPID_SDKDeleteKey', 'SRESoundEnd',
    'SPSUnknown', 'DISPID_SRCVoice', 'DISPID_SGRSTType',
    'ISpeechPhoneConverter', 'DISPID_SPIAudioSizeTime',
    'SPPS_RESERVED3', 'DISPID_SPPsItem', 'SpMMAudioIn',
    'DISPID_SGRSAddSpecialTransition', 'SPCS_DISABLED', 'SRAONone',
    'DISPID_SGRAddResource', 'DISPID_SRRGetXMLErrorInfo',
    'SPPROPERTYINFO', 'SPVOICESTATUS', 'SPEI_SR_AUDIO_LEVEL',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpProperties',
    'SPEI_INTERFERENCE', 'SVP_21', 'SPEI_MIN_SR', 'DISPID_SGRsCommit',
    'DISPID_SRGDictationSetState', 'ISequentialStream', 'SP_VISEME_4',
    'SPWORD', 'SITooSlow', 'SAFT12kHz8BitMono', 'LONG_PTR',
    'SpeechVisemeFeature', 'IInternetSecurityMgrSite',
    'SREPropertyNumChange', 'DISPID_SVEStreamStart', 'SPEI_MAX_TTS',
    'SPEI_RESERVED1', 'SVP_20', 'SP_VISEME_0', 'SPXRO_SML',
    'DISPID_SRCreateRecoContext', 'IInternetSecurityManager',
    'SpCompressedLexicon', 'SpObjectToken', 'SAFT22kHz8BitStereo',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechLexiconWords', 'SPSHORTCUTPAIR',
    'DISPID_SPEDisplayAttributes', 'SECLowConfidence', 'SP_VISEME_21',
    'SVP_16', 'DISPID_SVEStreamEnd', 'eWORDTYPE_DELETED',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPEI_VOICE_CHANGE',
    'SDTAll', 'SREHypothesis', 'DISPID_SPRFirstElement',
    'DISPID_SRRSaveToMemory', 'SPRULE',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SGRSTRule',
    'DISPID_SPERetainedSizeBytes', 'ISpRecoContext2',
    'DISPID_SGRSTPropertyValue', 'DISPID_SOTsCount',
    'ISpeechLexiconWords', 'SPRECORESULTTIMES',
    'DISPID_SpeechPhraseInfo', 'SPRECOSTATE', 'SPPHRASEPROPERTY',
    'SP_VISEME_1', 'SPAR_Low', 'SRADefaultToActive', 'SpMMAudioEnum',
    'DISPID_SRCESoundEnd', 'eLEXTYPE_PRIVATE18', 'DISPID_SLWsCount',
    'SpeechAddRemoveWord', 'DISPID_SGRs_NewEnum',
    'DISPID_SpeechRecoResult', 'SpeechFormatType',
    'DISPID_SpeechObjectToken', 'SDA_No_Trailing_Space',
    'SpeechRecoEvents', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SADefaultFormat',
    'SP_VISEME_14', 'SGLexicalNoSpecialChars', 'DISPID_SOTDisplayUI',
    'SREPhraseStart', 'DISPID_SRCEFalseRecognition',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVEEnginePrivate',
    'SVPAlert', 'SLTApp', 'SREFalseRecognition',
    'SPEI_RECO_OTHER_CONTEXT', 'ISpeechLexicon', 'SVP_11',
    'DISPID_SVEViseme', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SGRsCommitAndSave', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRSNumberOfActiveRules', 'SPLOADOPTIONS',
    'ISpeechBaseStream', 'DISPID_SpeechDataKey',
    'DISPID_SRGCmdSetRuleIdState', 'eLEXTYPE_RESERVED7',
    'SPSEMANTICERRORINFO', 'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechWordType', 'DISPID_SWFEFormatTag', 'SGPronounciation',
    'SpeechPropertyComplexResponseSpeed', 'SPSEMANTICFORMAT',
    'DISPID_SPIRule', 'SpeechRecognitionType',
    'SpeechStreamSeekPositionType', 'SVSFParseAutodetect',
    'SAFTNoAssignedFormat', 'DISPID_SREmulateRecognition',
    'DISPID_SRCEHypothesis', 'SRAInterpreter',
    'DISPID_SVSyncronousSpeakTimeout', 'SVSFDefault', 'SVSFNLPMask',
    'SRCS_Disabled', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SGRsAdd', 'DISPID_SGRsCount', 'DISPID_SGRSRule',
    'eLEXTYPE_RESERVED4', 'DISPID_SRAudioInput', 'SVP_5',
    'ISpRecoContext', 'SpeechRegistryLocalMachineRoot', 'SVP_14',
    'DISPID_SRCCreateGrammar', 'DISPID_SpeechRecoResult2',
    'DISPID_SDKSetStringValue', 'SPEI_RECOGNITION',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRDisplayUI', 'SPPHRASEELEMENT',
    'DISPID_SPIGetText', 'SPCT_COMMAND', 'SSSPTRelativeToStart',
    'DISPID_SRCEInterference', 'SVSFParseMask',
    'SPADAPTATIONRELEVANCE', 'ISpeechPhraseInfo', 'DISPID_SPEsItem',
    'DISPID_SpeechAudio', 'SPSERIALIZEDPHRASE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SRCRecognizer',
    'SPEI_PHRASE_START', 'SPEI_RESERVED5', 'SRTSMLTimeout',
    'SPEI_WORD_BOUNDARY', 'ISpRecognizer2', 'SpShortcut', 'SVP_9',
...
_check_version('1.1.14', 1602276449.902404)
